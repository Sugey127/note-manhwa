...
>
	...
	<div class="flex-1 flex flex-col">
		...
		<div class="mt-4 flex flex-col md:flex-row md:justify-end space-y-2 md:space-y-0 md:space-x-2">
			<button onclick={handleUpdate} class="bg-blue text-white px-4 py-2 rounded w-full md:w-auto">Editar</button>
			<button onclick={handleDelete} class="bg-base text-white px-4 py-2 rounded w-full md:w-auto"
				>Eliminar</button
			>
		</div>
	</div>
